DEVELOPER: Replace the three occurrences of BeCyIconGrabberPortable in this file
...
user in an INI file next to BeCyIconGrabberPortable.exe called BeCyIconGrabberPortable.ini.
...
copy AppNamePortable.ini from this directory to BeCyIconGrabberPortable.ini next to
BeCyIconGrabberPortable.exe. The options in the INI file are as follows:
